...
| `-it`                           | Combines two flags (`-i` and `-t`) to keep standard input open. Enables interactive communication with the container (similar to SSH).                                                           |
| `-i` or `--interactive`         | Keeps the container’s standard input open, even if not attached.                                                                                                                                                    |
